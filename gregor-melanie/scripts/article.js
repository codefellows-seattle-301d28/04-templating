...
Article.prototype.toHtml = function() {
  ...
  let compiledHandlebars = handlebars(this);
  ...
  // console.log(compiledHandlebars);
  $('#articles').append(compiledHandlebars);
};

// COMMENT: Why are there parentheses around "(a,b)" in the .sort() method, but not around the "articleObject" or "article" arguments in the .forEach() methods?
// With the fat arrow method when passing in multiple parameter a parenthesis is needed. forEach only has one parameter so it doesn't require the parenthesis
rawData.sort((a,b) => {
